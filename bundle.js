(function () {
	...
	function centroid(object) {
	  ...
	  return [atan2(y, x) * degrees$2, asin$1(z / m) * degrees$2];
	}
	...
	function polygonContains(polygon, point) {
	  ...
	  for (var i = 0, n = polygon.length; i < n; ++i) {
	    ...
	    for (var j = 0; j < m; ++j, lambda0 = lambda1, sinPhi0 = sinPhi1, cosPhi0 = cosPhi1, point0 = point1) {
	      ...
	      sum.add(atan2(k * sign * sin$2(absDelta), cosPhi0 * cosPhi1 + k * cos$2(absDelta)));
	...
	function interpolate$2(a, b) {
	  ...
	  var interpolate = d ? function(t) {
	    ...
	    return [
	      atan2(y, x) * degrees$2,
	      atan2(z, sqrt$1(x * x + y * y)) * degrees$2
	    ];
	  } : function() {
	...
	function conicConformalRaw(y0, y1) {
	  var cy0 = cos$2(y0),
	      n = y0 === y1 ? sin$2(y0) : log(cy0 / cos$2(y1)) / log(tany(y1) / tany(y0)),
	      ...
	      if (rc > epsilon$5) {
	        ...
	        if (da < pi$4 && (oc = intersect(x01, y01, x00, y00, x11, y11, x10, y10))) {
	          var ax = x01 - oc[0],
	              ...
	              bx = x11 - oc[0],
	              by = y11 - oc[1],
	              kc = 1 / sin$3(acos$1((ax * bx + ay * by) / (sqrt$3(ax * ax + ay * ay) * sqrt$3(bx * bx + by * by))) / 2),
